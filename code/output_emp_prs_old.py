...
def main(tree_path, tree_ld_path, p_thresh, sum_stats,vcf_file=None,m=1000,h2=0.67,r2=0.2):
    #tree, tree_LD = msprime.load(tree_path), msprime.load(tree_ld_path)
    tree_LD = msprime.load(tree_ld_path)
    var2mut, mut2var = {}, {}
    ...
    #     with h5py.File('emp_prs/emp_prs_m_{}_h2_{}_ld_{}.hdf5'.format(m,h2,tree_ld_path[11:14]), 'w') as f:
